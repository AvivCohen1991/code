...
def parse_args():
    ...
    parser.add_argument('--cross_validation', action='store_true', default=False,
                        help='cross validation (default: False)')
    ...
    parser.add_argument('--model-name', default='tartanvo_1914.pkl',
                        help='name of pretrained model (default: "tartanvo_1914.pkl")')
    ...
    parser.add_argument('--attack_target_clean', action='store_true', default=False,
                        help='use the outputs from the model on clean data as attack target (default: False)')
